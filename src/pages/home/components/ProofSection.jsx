  ...
  return (
    ...
    >
      <SectionContainer maxWidth="1512px">
        <div className="flex flex-col gap-12 lg:min-h-[38rem] lg:flex-row lg:items-start lg:gap-14 xl:gap-20">
          <motion.div className="w-full lg:basis-[38rem] lg:shrink-0 xl:basis-[40rem]" variants={containerVariants}>
            <motion.p
            ...
            <motion.h2
              id="proof-title"
              className="mt-6 max-w-[10.25ch] font-brand-serif text-[clamp(3rem,5.2vw,5.35rem)] font-light leading-[0.91] tracking-[-0.075em] text-[color:var(--fg)] sm:max-w-[11ch]"
              variants={itemVariants}
            >
              <span className="block">{proofIntro.title[0]}</span>
              <span className="block">{proofIntro.title[1]}</span>
            </motion.h2>

            <motion.p
              className="mt-6 max-w-[32ch] text-[1rem] leading-[1.65] text-[color:var(--muted-strong)] sm:text-[1.12rem]"
              variants={itemVariants}
            >
          ...
          <motion.div
            className="w-full self-stretch lg:flex-1 lg:self-end lg:pb-0"
            variants={containerVariants}
          >
...
function TestimonialCard() {
  return (
    <motion.figure
      className="mt-9 rounded-[1.45rem] border border-[color:var(--line)] bg-[color:var(--panel)] px-5 py-6 sm:mt-10 sm:px-8 sm:py-8 lg:mt-11 lg:px-10 lg:py-11"
      variants={itemVariants}
    >
